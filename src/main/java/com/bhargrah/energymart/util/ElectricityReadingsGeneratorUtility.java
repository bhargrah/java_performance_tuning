...
public class ElectricityReadingsGeneratorUtility {

    public static final Logger LOGGER = Logger.getLogger("com.bhargrah.energymart.util.ElectricityReadingsGeneratorUtility");
